...
const UTILITY_ASSET_ROOT = "/_utilities/tools";
...
export const getUtilityOgImage = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/tools/images/${englishSlug}.webp`);

export const getUtilityCssPath = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/tools/styles/${englishSlug}.css`);

export const CATEGORY_OG_IMAGE = getUtilityOgImage("tools");
